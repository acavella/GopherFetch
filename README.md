...
1. Download the [latest RPM build](https://github.com/acavella/GopherFetch/releases/latest/) appropriate for your platform:
   - EL8 (amd64): `gfetch-<version>.el8.x86_64.rpm`
   - EL9 (amd64): `gfetch-<version>.el9.x86_64.rpm`
   - EL10 (amd64): `gfetch-<version>.el10.x86_64.rpm`
2. Install the RPM with the appropriate package manager command, `sudo dnf install gfetch-<version>.el9.x86_64.rpm`
3. Edit the configuration at `/etc/gfetch.yaml`
> [!NOTE]
...
4. Start and enable the gfetch systemd service:
   ```shell
